...
async def extract_info(db: Session = Depends(get_database_session)):
    # add data to database 
    name = "test 6"
    desc = "a"
    type = "movies"
...
async def extract_student_card(db: Session = Depends(get_database_session)):
    # add data to database 
    name = "a1"
    desc = "a"
    type = "movies"
