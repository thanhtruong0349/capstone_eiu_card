...
# YOLO options
__C.YOLO                      = edict()
# __C.YOLO.BASE = os.getcwd().replace(os.sep, '/source/Controllers')
__C.YOLO.BASE = os.getcwd().replace(os.sep, '/')
# __C.YOLO.CLASSES              = "./data/classes/coco.names"
# __C.YOLO.CLASSES              = "./data/classes/cards.names"
__C.YOLO.CLASSES              = __C.YOLO.BASE + "/sources/data/classes/student_card.names"
